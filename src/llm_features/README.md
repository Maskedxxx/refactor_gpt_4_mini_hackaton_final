...
**Примеры фич:**
- `cover_letter` — генерация сопроводительных писем
- `gap_analyzer` — анализ пробелов в навыках
...
### Смотрите готовую реализацию:
- `src/llm_cover_letter/` — полный пример рабочей фичи
